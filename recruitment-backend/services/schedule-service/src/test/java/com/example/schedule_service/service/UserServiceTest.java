...
class UserServiceTest {
    ...
    void testGetEmployeeNamesAndDepartmentNames_FallbackUnknown_SCH_USER_TC_005() {
        ...
        // Objective: Xác nhận fallback departmentName là "Unknown" khi thiếu/không đúng kiểu department
        ...
        // act
        ResponseEntity<JsonNode> result = userService.getEmployeeNamesAndDepartmentNames(employeeIds, null); // token null branch
    ...
    void testGetAllEmployeeIds_Delegates_SCH_USER_TC_011() {
        ...
        // Objective: Xác nhận getAllEmployeeIds delegate đúng params sang getEmployeeIdsByFilters
